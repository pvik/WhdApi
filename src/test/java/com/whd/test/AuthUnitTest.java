...
public class AuthUnitTest {
    ...
    public void testAuthenticatePassword() throws WhdException {
        WhdAuth auth = new WhdAuth(TestDetails.whdUri, Util.WHD_AUTH_TYPE.PASSWORD, TestDetails.username, TestDetails.password);
    ...
    public void testAuthenticateSessionKey() throws WhdException {
        WhdAuth auth = new WhdAuth(TestDetails.whdUri, Util.WHD_AUTH_TYPE.PASSWORD, TestDetails.username,  null);
        // If authenticate() fails, then WhdException will be thrown, 
        //     failing the test case
    ...
    public void testAuthenticateApiKey() {
        WhdAuth auth = new WhdAuth(TestDetails.whdUri, Util.WHD_AUTH_TYPE.PASSWORD, TestDetails.username,  TestDetails.apiKey);
    ...
    public void testAuthenticatePasswordFail() throws WhdException {
        WhdAuth auth = new WhdAuth(TestDetails.whdUri, Util.WHD_AUTH_TYPE.PASSWORD, TestDetails.username, TestDetails.password+ "abc");
        auth.authenticate();
    }
